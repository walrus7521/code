...
body_line:
        ...
        | ACTIVATE LPAREN INT RPAREN ENDLS { printf("activate: %d\n", $3); }
        | ASSOCIATE LPAREN exps RPAREN ENDLS { printf("associate: %d\n", $3); }
        | UNASSOCIATE LPAREN INT PARM_SEP INT RPAREN ENDLS { printf("unassociate: %d\n", $3); }
        | WAIT_ON_SIGNAL LPAREN INT PARM_SEP INT RPAREN ENDLS { printf("wait_on_signal: %d\n", $3); }
        | LOG LPAREN INT RPAREN ENDLS { printf("log: %d\n", $3); }
        ;
