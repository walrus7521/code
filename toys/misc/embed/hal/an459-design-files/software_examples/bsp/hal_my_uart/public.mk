...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../../AN459_top.jdi
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1427186341
SOPC_SYSID_FLAG += --timestamp=1427186341
ELF_PATCH_FLAG  += --timestamp 1427186341
...
# setting hal.log_flags is 3
ALT_CPPFLAGS += -DALT_LOG_FLAGS=3
...
# setting hal.stdout is uart1
ELF_PATCH_FLAG  += --stdout_dev uart1

# Enable driver ioctl() support none 
# setting my_uart_driver.enable_ioctl is false

# Small-footprint (polled mode) driver none 
# setting my_uart_driver.enable_small_driver is false
