// Demos use of the following methods of the C# lock keyword and the Monitor class in threads:
...
public class CellCons
{
   ...
   public void ThreadRun() {
      int valReturned;
      for(int looper=1; looper<=quantity; looper++)
         valReturned=cell.ReadFromCell( ); // Consume result by placing it in valReturned
   }
}
