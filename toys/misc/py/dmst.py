...
#arcs = [Arc(1, 5, 2), Arc(1, 3, 3), Arc(4, 6, 1), Arc(2, 7, 4), Arc(3, 4, 2), Arc(3, 5, 4)]
arcs = [Arc(1, 5, 2), Arc(2, 5, 1), Arc(1, 3, 3), Arc(3, 3, 1), Arc(4, 6, 1), Arc(1, 6, 4), Arc(2, 7, 4), Arc(4, 7, 2), Arc(3, 4, 2), Arc(2, 4, 3), Arc(3, 5, 4), Arc(4, 5, 3)]
print(min_spanning_arborescence(arcs, 1))
