...
enum    {                               // Table 9      Table 10
                                        // =======      ========
    UART_RX_DATA    = UART_BASE + 0,    //  RHR         = 0x00  R
    UART_TX_DATA    = UART_BASE + 0,    //  THR         = 0x00  W
    UART_DLATCH_LO  = UART_BASE + 0,    //  DLL    EX   = 0x00  RW
    UART_DLATCH_HI  = UART_BASE + 1,    //  DLH    EX   = 0x01  RW
    UART_INTR_EN    = UART_BASE + 1,    //  IER         = 0x01  RW
    UART_INTR_ID    = UART_BASE + 2,    //  IIR         = 0x02  R
    UART_FIFO_CTRL  = UART_BASE + 2,    //  FCR         = 0x02  W
    UART_LINE_CTRL  = UART_BASE + 3,    //  LCR         = 0x03  RW
    UART_MODEM_CTRL = UART_BASE + 4,    //  MCR         = 0x04  RW
    UART_LINE_STAT  = UART_BASE + 5,    //  LSR         = 0x05  R
    UART_MODEM_STAT = UART_BASE + 6,    //  MSR         = 0x06  R
    UART_SCRATCH    = UART_BASE + 7,    //  SPR         = 0x07  RW
    };
